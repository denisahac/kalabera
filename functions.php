...
Description: WordPress custom theme functionality
Author: den.isahac
...
require_once( 'library/kalabera.php' );
...
function bones_ahoy() {
  ...
  load_theme_textdomain( 'kalabera', get_template_directory() . '/library/translations' );
...
function bones_register_sidebars() {
	register_sidebar(array(
		'id' => 'sidebar1',
		'name' => __( 'Sidebar 1', 'kalabera' ),
		'description' => __( 'The first (primary) sidebar.', 'kalabera' ),
	...
	register_sidebar(array(
		'id' => 'sidebar2',
		'name' => __( 'Sidebar 2', 'kalabera' ),
		'description' => __( 'The second (secondary) sidebar.', 'kalabera' ),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h4 class="widgettitle">',
		'after_title' => '</h4>',
