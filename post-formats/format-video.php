              ...
              <article id="post-<?php the_ID(); ?>" <?php post_class('article'); ?> role="article" itemscope itemtype="http://schema.org/VideoObject">
                ...
                <section class="article__content" itemprop="description">
                  <?php
