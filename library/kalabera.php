...
function bones_theme_support() {
	...
	register_nav_menus(
		array(
			'main-nav' => __( 'The Main Menu', 'kalabera' ),   // main nav in header
			'footer-links' => __( 'Footer Links', 'kalabera' ) // secondary nav in footer
		)
	);
...
function bones_related_posts() {
	...
	if($tags) {
		...
		if($related_posts) {
			...
			<?php echo '<li class="no_related_post">' . __( 'No Related Posts Yet!', 'kalabera' ) . '</li>'; ?>
		<?php }
	}
	wp_reset_postdata();
	echo '</ul>';
